package components
{
	...
	[Embed(source="/modules/uibase_assets.swf", symbol="symbol1279")]
	public class SerialCharComponent extends UIComponent
	{
		public var mc:MovieClip;

		private var $character:String = "SERIAL1";
		...
		public function SerialCharComponent()
		{
			super();
		}
		...
		{
			super.configUI();
			var cclass:Object = Modules.GetClass("serialboosterchars", "SerialBoosterChars");
			this.mc = new cclass();
			addChild(this.mc);
