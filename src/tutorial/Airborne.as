package tutorial
{
	...
	[Embed(source="/modules/tutorial_assets.swf", symbol="symbol437")]
	public class Airborne extends MovieClip
	{
		...
		{
			this.texts[0] = [Lang.Get("tut_2_airborne_s00"), Lang.Get("tut_2_airborne_s01")];
			this.texts[1] = [Lang.Get("tut_2_airborne_s02"), Lang.Get("tut_2_airborne_s03")];
			this.texts[2] = [Lang.Get("tut_2_airborne_s04"), Lang.Get("tut_2_airborne_s05")];
			this.texts[3] = [Lang.Get("tut_2_airborne_s06"), Lang.Get("tut_2_airborne_s07")];
			this.texts[4] = [Lang.Get("tut_2_airborne_s08"), Lang.Get("tut_2_airborne_s09")];
			this.buildingname = "Wizard";
			this.iconname = "AIRBORNE";
			this.NPC.Set("WIZARD", "DEFAULT");
		...
		public function DrawPage():void
		{
			...
			this.NPC.Set("WIZARD", this.npcframes[this.index]);
