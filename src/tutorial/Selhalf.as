package tutorial
{
	...
	[Embed(source="/modules/tutorial_assets.swf", symbol="symbol427")]
	public class Selhalf extends MovieClip
	{
		public static var mc:Selhalf = null;
		...
		{
			this.texts[0] = [Lang.Get("tut_2_selhalf_s00"), Lang.Get("tut_2_selhalf_s01")];
			this.texts[1] = [Lang.Get("tut_2_selhalf_s02"), Lang.Get("tut_2_selhalf_s03")];
			this.texts[2] = [Lang.Get("tut_2_selhalf_s04"), Lang.Get("tut_2_selhalf_s05")];
			this.texts[3] = [Lang.Get("tut_2_selhalf_s06"), Lang.Get("tut_2_selhalf_s07")];
			this.texts[4] = [Lang.Get("tut_2_selhalf_s08"), Lang.Get("tut_2_selhalf_s09")];
