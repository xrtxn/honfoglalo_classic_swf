package tutorial
{
	...
	[Embed(source="/modules/tutorial_assets.swf", symbol="symbol418")]
	public class Tipaver extends MovieClip
	{
		public static var mc:Tipaver = null;
		...
		{
			this.texts[0] = [Lang.Get("tut_2_tipaver_s00"), Lang.Get("tut_2_tipaver_s01")];
			this.texts[1] = [Lang.Get("tut_2_tipaver_s02"), Lang.Get("tut_2_tipaver_s03")];
			this.texts[2] = [Lang.Get("tut_2_tipaver_s04"), Lang.Get("tut_2_tipaver_s05")];
			this.texts[3] = [Lang.Get("tut_2_tipaver_s06"), Lang.Get("tut_2_tipaver_s07")];
			this.texts[4] = [Lang.Get("tut_2_tipaver_s08"), Lang.Get("tut_2_tipaver_s09")];
			this.buildingname = "Petmerchant";
			this.iconname = "TIPAVER";
			this.NPC.Set("PET_MERCHANT", "DEFAULT");
		...
		public function DrawPage():void
		{
			...
			this.NPC.Set("PET_MERCHANT", this.npcframes[this.index]);
