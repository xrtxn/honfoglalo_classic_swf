package tutorial
{
	...
	[Embed(source="/modules/tutorial_assets.swf", symbol="symbol417")]
	public class Tiprang extends MovieClip
	{
		public static var mc:Tiprang = null;
		...
		{
			this.texts[0] = [Lang.Get("tut_2_tiprang_s00"), Lang.Get("tut_2_tiprang_s01")];
			this.texts[1] = [Lang.Get("tut_2_tiprang_s02"), Lang.Get("tut_2_tiprang_s03")];
			this.texts[2] = [Lang.Get("tut_2_tiprang_s04"), Lang.Get("tut_2_tiprang_s05")];
			this.texts[3] = [Lang.Get("tut_2_tiprang_s06"), Lang.Get("tut_2_tiprang_s07")];
			this.texts[4] = [Lang.Get("tut_2_tiprang_s08"), Lang.Get("tut_2_tiprang_s09")];
			this.buildingname = "Scientist";
			this.iconname = "TIPRANG";
		...
		public function DrawPage():void
		{
			...
			this.NPC.Set("PROFESSOR", this.npcframes[this.index]);
