package tutorial
{
	...
	[Embed(source="/modules/tutorial_assets.swf", symbol="symbol425")]
	public class Subject extends MovieClip
	{
		public static var mc:Subject = null;
		...
		{
			this.texts[0] = [Lang.Get("tut_2_subject_s00"), Lang.Get("tut_2_subject_s01")];
			this.texts[1] = [Lang.Get("tut_2_subject_s02"), Lang.Get("tut_2_subject_s03")];
			this.texts[2] = [Lang.Get("tut_2_subject_s04"), Lang.Get("tut_2_subject_s05")];
			this.texts[3] = [Lang.Get("tut_2_subject_s06"), Lang.Get("tut_2_subject_s07")];
			this.texts[4] = [Lang.Get("tut_2_subject_s08"), Lang.Get("tut_2_subject_s09")];
			this.buildingname = "General";
			this.iconname = "SUBJECT";
			this.NPC.Set("GENERAL", "DEFAULT");
		...
		public function DrawPage():void
		{
			...
			this.NPC.Set("GENERAL", this.npcframes[this.index]);
