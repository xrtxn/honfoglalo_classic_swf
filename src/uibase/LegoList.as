package uibase
{
	...
	public class LegoList extends MovieClip
	{
		...
		public var scrollbar:LegoScrollBarMov;
		...
		public function LegoList()
		{
			this.pool = [];
			super();
		}

		public function Set(prefix:*, list:Array, itemheight:int, columns:int = 1, clickfunc:Function = null, drawfunc:Function = null, scrollrect:MovieClip = null, scrollbar:LegoScrollBarMov = null):*
		{
			var s:* = undefined;
			var c:* = undefined;
		...
		public function SetScrollBar(scrollbar:LegoScrollBarMov):void
		{
