package uibase.components
{
	...
	public class LegoCommonGfx extends UIComponent
	{
		...
		public function GetMCById(gfxid:String):MovieClip
		{
			...
			if (gfxid != "")
			{
				try
				{
					sclass = Modules.GetClass("uibase", "uibase.gfx." + gfxid);
				}
				catch (e:Error)
				{
			...
			if (!sclass)
			{
				try
				{
					sclass = Modules.GetClass("uibase", "uibase.gfx.invalidgfx");
				}
				catch (e:Error)
				{
				}
