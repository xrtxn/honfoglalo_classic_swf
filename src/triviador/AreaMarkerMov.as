package triviador
{
	...
	import uibase.SoldierMov;
	import triviador.compat.TriviadorSoldierMov;
	import minitournament.compat.MinitournamentSoldierMov;
	...
	public class AreaMarkerMov extends MovieClip
	{
		...
		{
			trace("AreaMarkerMov.Setup pn: " + pnum + " val: " + val + " tow: " + tow);
			...
			if (pnum == 0)
			{
				...
				trace("before adjustsetup");
				var adj:TriviadorSoldierMov = TriviadorSoldierMov(this.SOLDIER.ADJUST);
				this.SOLDIER.ADJUST.Setup(this.skin, 4);
				this.CASTLE.Setup(1, 1, 3);
				trace("after adjustsetup");
			}
			else
			{
