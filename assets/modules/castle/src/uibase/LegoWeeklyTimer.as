package uibase {
		...
		public class LegoWeeklyTimer extends MovieClip {
				...
				public function LegoWeeklyTimer() {
						super();
						trace("LegoWeeklyTimer.Constructor");
						this.visible = false;
				}
				...
				public function UpdateRLResetTime(e:TimerEvent = null) : void {
						...
						var sec:String = null;
						var ts:String = null;
						trace("LegoWeeklyTimer.UpdateRLResetTime");
				...
				public function Start() : void {
						trace("LegoWeeklyTimer.Start");
						this.UpdateRLResetTime();
				}
				
				public function Destroy() : void {
						trace("LegoWeeklyTimer.Destroy");
