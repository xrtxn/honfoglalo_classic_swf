package triviador {
		...
		import flash.utils.*;
		import syscode.*;
		import syscode.guessquestion.BoosterButton;
		import uibase.UniqueButton;
		
		[Embed(source="/_assets/assets.swf", symbol="symbol1057")]
		public class MCQuestionMov extends MovieClip {
				...
				public function Show() : void {
						...
						if(passive) {
								this.BTNRATE1.Set(UniqueButton.DISLIKE_FRAME,this.OnRateButtonClick);
								this.BTNRATE5.Set(UniqueButton.LIKE_FRAME,this.OnRateButtonClick);
