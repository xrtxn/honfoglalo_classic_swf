package syscode {
		...
		public class Util {
				...
				public static function AddNameCapture(_container:MovieClip, _name:String, _txtField:TextField) : void {
				}
				...
				public static function FormatRemaining(asecs:Number, separatedays:Boolean = true) : String {
						return null;
				}
				...
				public static function GetRTLEditText(tf:TextField) : * {
						return null;
				}
				...
				public static function NumberVal(num:*, defval:* = 0) : Number {
						return -1;
				}
				...
				public static function RTLSwap(id:String, obj1:DisplayObject, obj2:DisplayObject, keeplayout:Boolean = false) : void {
				}
				
				public static function SetColor(amc:DisplayObject, acolor:uint) : * {
				}
