		...
		public class Random {
				...
				public function Random(prng:Class = null) {
						...
						while(this.pptr < this.psize) {
								...
								var _loc4_:*;
								this.pool[_loc4_ = this.pptr++] = t & 0xFF;
						}
						this.pptr = 0;
						this.seed();
				}
				...
				public function seed(x:int = 0) : void {
						...
						this.pool[_loc2_] ^= x & 0xFF;
						var _loc3_:* = this.pptr++;
						this.pool[_loc3_] ^= x >> 8 & 0xFF;
						var _loc4_:*;
						this.pool[_loc4_ = this.pptr++] = this.pool[_loc4_] ^ x >> 16 & 0xFF;
						var _loc5_:*;
						this.pool[_loc5_ = this.pptr++] = this.pool[_loc5_] ^ x >> 24 & 0xFF;
